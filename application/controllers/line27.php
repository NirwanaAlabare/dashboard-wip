...
class line27 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['setting'] = $this->Model_line27->getDashboardSetting();
        ...
        $data['rftsl27'] = $this->Model_line27->cari_rfts();
    ...
    public function dashboard1()
    {
        ...
        $data['menpowerl27'] = $this->Model_line27->cari_menpower();
        //data
        $data['datajam7'] = $this->Model_line27->cari_datajam7();
        $data['datajam8'] = $this->Model_line27->cari_datajam8();
        $data['datajam9'] = $this->Model_line27->cari_datajam9();
        $data['datajam10'] = $this->Model_line27->cari_datajam10();
        $data['datajam11'] = $this->Model_line27->cari_datajam11();
        $data['datajam13'] = $this->Model_line27->cari_datajam13();
        $data['datajam14'] = $this->Model_line27->cari_datajam14();
        $data['datajam15'] = $this->Model_line27->cari_datajam15();
        // $data['datajam16'] = $this->Model_line27->cari_datajam16();

        $this->load->view('templates/header', $data);
        $html = $this->load->view('line27/landingpage2', $data, true);
     ...
     public function dashboard3()
    {
        ...
        $data['link_gambar1'] = $this->Model_line27->cari_link_gambar1();
        $data['positiondefect'] = $this->Model_line27->cari_positiondefect();
