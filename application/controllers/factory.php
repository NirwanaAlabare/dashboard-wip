...
class factory extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['data_effi'] = $this->Model_factory->cari_data_effi();
        $data['sum_rft'] = $this->Model_factory->cari_sum_rft();
        $data['data_rft'] = $this->Model_factory->cari_data_rft();
    ...
    public function dashboard1()
    {
        ...
        // $data['efficiency_factory'] = $this->Model_factory->cari_efficiency_factory();
        // $data['sum_effi'] = $this->Model_factory->cari_sum_effi();
        $data['output_factory_s1'] = $this->Model_factory->cari_output_factory();
        $data['output_factory_s2'] = $this->Model_factory->cari_output_factory2();
        $data['output_factory_s3'] = $this->Model_factory->cari_output_factory3();
        $data['output_factory_s4'] = $this->Model_factory->cari_output_factory4();
        $data['output_factory_s5'] = $this->Model_factory->cari_output_factory5();
        $data['output_factory_s6'] = $this->Model_factory->cari_output_factory6();
        $data['jmlslide'] = $this->Model_factory->cari_jmlslide();
        // $data['jamker'] = $this->Model_factory->cari_jamker();
        // $data['actual'] = $this->Model_factory->cari_actual();
        // $data['smv'] = $this->Model_factory->cari_smv();
        // $data['menpower'] = $this->Model_factory->cari_menpower();
        ...
        $this->load->view('templates_factory/header', $data);
        $this->load->view('factory/landingpage1', $data);
        $this->load->view('templates_factory/footer', $data);
    }
    ...
    public function dashboard2()
    {
        ...
        $this->load->view('templates_factory/header', $data);
        $this->load->view('factory/landingpage2', $data);
        $this->load->view('templates_factory/footer', $data);
    }
