        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 300px;">
                            ...
                            <span class="text-bold" style="font-size: 25px;text-align: center;">Efficiency <?= $tanggal_kerja; ?></span>
                        </p>
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-lg-3">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 300px;">
                            ...
                            <p class="d-flex flex-column">
                            <span class="text-bold" style="font-size: 25px;text-align: center;">RFT Rate <?= $tanggal_kerja; ?></span>
                        </p>
                        </div>
                    </div>
                </div> 
                ...
                <div class="col-lg-6">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 300px;">
                            <span class="text-bold" style="font-size: 25px;text-align: center;">Top 5 Line <?= $tanggal_kerja; ?> <ion-icon name="arrow-up-circle-outline" style= "color: green;"></ion-icon></span>
                            <div>
                                ...
                                <thead>
                                    <tr style="line-height: 15px;">
                                        ...
                                        <th scope="col" style="width: 23%">Efficiency</th>
                                        <th scope="col" style="width: 23%">RFT</th>
                                        <th scope="col" style="width: 23%">Defect</th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                <div class="col-lg-6">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 300px;padding-top: -30px;">
                            <span class="text-bold" style="font-size: 25px;text-align: center;">Top 5 Defect <?= $tanggal_kerja; ?></span>
                ...
                <div class="col-lg-6">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 300px;">
                            <span class="text-bold" style="font-size: 25px;text-align: center;">Most Defect Line <?= $tanggal_kerja; ?> <ion-icon name="arrow-down-circle-outline" style= "color: red;"></ion-icon></span>
                            <div>
                               <table class="table table-striped" width="100%">
                                <thead>
                                    <tr style="line-height: 15px;">
