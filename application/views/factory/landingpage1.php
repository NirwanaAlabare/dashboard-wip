                ...
                <div class="col-lg-12">
                    <div class="card bg-secondary">
                        ...
                        <p class="d-flex flex-column">
                            <span class="text-bold" style="font-size: 22px;text-align: center;margin-top: -1rem;color: white;">OUTPUT FACTORY TODAY - <?php
                                        ...
                                        <?php foreach ($output_factory_s1 as $outfac1) : ?>
                                            <tr style="line-height: 0.6rem;font-size: 12px;text-align: center;vertical-align: middle;">
                                                ...
                                                <td  <?php if ($outfac1['per_rft'] > 0 || $outfac1['per_defect'] > 0 || $outfac1['per_reject'] > 0 ) { if ($outfac1['per_rft'] >= 97 || $outfac1['per_rft'] == 0) {
                                                    echo 'style = "background-color: #32CD32;color:black;font-weight: bold;;font-weight: bold;"';
                                                }else{
                                                    echo 'style = "background-color: #FF3333;color:black;font-weight: bold;color:black;font-weight: bold;;font-weight: bold;"';
                                                ...
                                                <td  <?php if ($outfac1['per_rft'] > 0 || $outfac1['per_defect'] > 0 || $outfac1['per_reject'] > 0 ) { if ($outfac1['per_defect'] > 3 ) {
                                                    echo 'style = "background-color: #FF3333;color:black;font-weight: bold;"';
                                                }else{
                                                    echo 'style = "background-color: #32CD32;color: black;font-weight: bold;"';
                                                ...
                                                <?php if ($line != $outfac1['nama_line']) {
                                                    ...
                                                    echo 'style = "background-color: #32CD32;color:black;font-weight: bold;;font-weight: bold;text-align: center;vertical-align: middle;"';
                                                }else{
                                                    echo 'style = "background-color: #FF3333;color:black;font-weight: bold;;font-weight: bold;text-align: center;vertical-align: middle;"';
                                                } ?>><?= $outfac1['effi']; ?> %</td>
                                                    <?php } else { ?>
                                                    <td hidden></td>
                                                <?php } ?>
                                        ...
                                        <?php foreach ($output_factory_s1 as $outfac1) : ?>
                                            <tr style="line-height: 0.6rem;font-size: 12px;text-align: center;vertical-align: middle;">
                                                ...
                                                <?php if ($line != $outfac1['nama_line']) {
                                                    $sizeStartRow = $counter; ?>
                                                    <td rowspan="<?= $outfac1['jml_ws']; ?>"  <?php if ($outfac1['effi'] > 85 ) {
                                                    echo 'style = "background-color: #32CD32;color:black;font-weight: bold;;text-align: center;vertical-align: middle;"';
                                                }else{
                                                    echo 'style = "background-color: #FF3333;color:black;font-weight: bold;;text-align: center;vertical-align: middle;"';
                                                } ?>><?= $outfac1['effi']; ?> %</td>
                                                    <?php } else { ?>
                                                    <td hidden></td>
                                                <?php } ?>
