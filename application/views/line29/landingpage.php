        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 275px;">
                            <div id="chart_eff_line29" style="margin-bottom: -1rem; margin-top: -2rem;">
                            </div>
                            <p class="d-flex flex-column">
                ...
                <div class="col-lg-6">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 275px;">
                            <div id="chart_def_line29" style="margin-bottom: -1rem; margin-top: -2rem;">
                            </div>
                            <p class="d-flex flex-column">
...
var redirect = function() {
    window.location = "line29/dashboard1";
};
