                                                    ...
                                                    <?php if ($link_gambar1 != 0) { ?>
                                                        <div class="carousel-item active">
                                                            <div class="defect-area-img-container mx-auto overflow-hidden" style="height: 470px;padding-bottom: 20px;">
                                                                ...
                                                                <img style="opacity: .8;width: auto;height: 470px;" src='http://10.10.5.62:8080/erp/pages/prod_new/upload_files/' alt="product image" class="img-fluid defect-area-img" id="defect-area-img-show">
                                                            </div>
                                                        </div>
                                                    <?php } else { ?>
