...
<div class="col-12">
    <div class="row">
        <div class="col-lg-9" id="hourtable">
            <div class="card bg-secondary">
                <div class="card-body">
                    <?php 
                ...
                <!-- 08:00 - 09:00 -->
                <tr style="line-height: 18px;" <?php if ($datenow > '08:00' && $datenow <= '09:00') {
                    echo 'class="bg-info"';
                } ?>>
    ...
    <!-- 09:00 - 10:00 -->
    <tr style="line-height: 18px;" <?php if ($datenow > '09:00' && $datenow <= '10:00') {
        echo 'class="bg-info"';
    } ?>>
...
<!-- 10:00 - 11:00 -->
<tr style="line-height: 18px;" <?php if ($datenow > '10:00' && $datenow <= '11:00') {
    echo 'class="bg-info"';
} ?>>
...
<td style="border-color: lightgray;font-size: 18px;">
    ...
    if ($datenow > '10:00') {
        $cumulativeVariation += $variance10; 
    } 
    ?>
</td>
<td style="border-color: lightgray;font-size: 18px;">
...
<!-- 11:00 - 12:00 -->
<tr style="line-height: 18px;" <?php if ($datenow > '11:00' && $datenow <= '12:00') {
    echo 'class="bg-info"';
} ?>>
...
<td style="border-color: lightgray;font-size: 18px;">
    ...
    if ($datenow > '11:00') {
        $cumulativeVariation += $variance11; 
    } 
    ?>
</td>
<td style="border-color: lightgray;font-size: 18px;">
...
<!-- 13:00 - 14:00 -->
<tr style="line-height: 18px;" <?php if ($datenow > '13:00' && $datenow <= '14:00') {
    echo 'class="bg-info"';
} ?>>
...
<td style="border-color: lightgray;font-size: 18px;">
    ...
    if ($datenow > '13:00') {
        $cumulativeVariation += $variance13; 
    } 
    ?>
</td>
<td style="border-color: lightgray;font-size: 18px;">
...
<!-- 14:00 - 15:00 -->
<tr style="line-height: 18px;" <?php if ($datenow > '14:00' && $datenow <= '15:00') {
    echo 'class="bg-info"';
} ?>>
...
<td style="border-color: lightgray;font-size: 18px;">
    ...
    if ($datenow > '14:00') {
        $cumulativeVariation += $variance14; 
    }
...
<!-- 14:00 - 15:00 -->
<tr style="line-height: 18px;" <?php if ($datenow > '15:00' && $datenow <= '16:00') {
    echo 'class="bg-info"';
} ?>>
...
<td style="border-color: lightgray;font-size: 18px;">
    ...
    if ($datenow > '15:00') {
        $cumulativeVariation += $variance15; 
    }
    ?>
</td>
<td style="border-color: lightgray;font-size: 18px;">
    ...
    <td style="border-color: lightgray;font-size: 18px;">
        ...
        <td style="border-color: lightgray;font-size: 18px;">
            ...
            <td style="border-color: lightgray;font-size: 18px;">
                ...
                if ($datenow > '16:00') {
                    $cumulativeVariation += $variance16; 
                }
                ?>
            </td>
            <td style="border-color: lightgray;font-size: 18px;">
...
<!-- div 3 -->
<div class="col-lg-3" id="hourtablesummary">
    <div class="card bg-secondary">
        <div class="card-body">
            <table class="table table-dark" style="text-align: center;font-size: 14px;border-radius: 10px;">
                ...
                <tbody>
                    <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                        <td style="font-size: 22px;border-radius: 10px;font-weight: bold;"><?= $day_target; ?></td>
                    </tr>
                    <tr style="line-height: 22px;font-size: 16px;">
                        <th scope="row" style="font-size: 20px;">Output</th>
                    </tr>
                    <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                        <td style="font-size: 22px;border-radius: 10px;font-weight: bold;"><?= $actual; ?></td>
                    </tr>
                    <tr style="line-height: 22px;font-size: 16px;">
                        <th scope="row" style="font-size: 20px;">Variation</th>
                    </tr>
                    <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                        <td style="font-size: 22px;border-radius: 10px;font-weight: bold;">
                            <?php
                            $variance_sum = $day_target - $actual;
...
// echo $cumulativeVariation;

// if ($cumulativeVariation > 0) {
// echo '<ion-icon name="caret-down-outline" style= "color: red;"></ion-icon>';
// } else {
// echo '<ion-icon name="caret-up-outline" style= "color: green;"></ion-icon>';
// }
...
$percen_effi = $m_tersedia > 0 ? $m_prod / $m_tersedia * 100 : 0;

echo round($percen_effi, 2);
?>%</td>
</tr>
<tr style="line-height: 22px;font-size: 16px;">
...
<tr class="bg-light" style="line-height: 23px;font-size: 16px;">
    ...
    $deffect_sum = $deffect / $actual * 100;
    echo round($defects, 2);
?>%</td>
</tr>
</tbody>
</table>
...
<script type="text/javascript">
    ...
    var redirect = function() {
        if (!isPaused) {
            window.location = "/dashboard-wip/Line/dashboard2/<?= $line ?>";
        }
    };
