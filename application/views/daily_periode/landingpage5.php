                ...
                <div class="col-lg-12">
                    <div class="card bg-secondary">
                        ...
                        <p class="d-flex flex-column">
                            <span class="text-bold" style="font-size: 22px;text-align: center;margin-top: -1rem;color: black;"><?php echo strtoupper($bulan); ?> FACTORY DAILY EFFICIENCY</span>
                        </p>
