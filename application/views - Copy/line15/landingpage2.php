                                ...
                                <table class="table table-dark" style="text-align: center;font-size: 14px;border-radius: 10px;">
                                    ...
                                    <tbody>
                                        <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                            <td style="font-size: 22px;border-radius: 10px;font-weight: bold;"><?= $day_target15; ?></td>
                                        </tr>
                                        <tr style="line-height: 22px;font-size: 16px;">
                                            <th scope="row" style="font-size: 20px;">Output</th>
                                        </tr>
                                        <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                            <td style="font-size: 22px;border-radius: 10px;font-weight: bold;"><?= $actuall15; ?></td>
                                        </tr>
                                        <tr style="line-height: 22px;font-size: 16px;">
                                        ...
                                        <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                            <td style="font-size: 22px;border-radius: 10px;font-weight: bold;">
                                                <?php
                                                // $variance_sum = $day_target15 - $actuall15;
                                        ...
                                        <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                            <td style="font-size: 22px;border-radius: 10px;font-weight: bold;"><?php
                                                                                                                if ($day_target15 == '0') {
                                                                                                                    ...
                                                                                                                    $day_target15 = $day_target15;
                                                                                                                }
                                                                                                                $deffect_sum = $deffectl15 / $day_target15 * 100;
