    ...
    <div class="content animate__animated animate__fadeInLeft animate__slow" style="max-width: 1366px;max-height: 786px;">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-1">
                    <div class="card">
                    <img src="<?= base_url('assets/') ?>dist/img/logo-nds4.png" alt="Nag-Logo" class="brand-image elevation-2" style="width: 100px;height: 100px;">
                </div>
                </div>
                  ...
                  <div class="col-lg-7">
                    <div class="card bg-secondary">
                        ...
                        <div class="position-relative d-flex flex-column justify-content-center align-items-center">
                            ...
                            <div class="defect-area-img-container mx-auto overflow-hidden" style="height: 470px;width: 720px;padding-bottom: 20px;">
                                <?php foreach ($positiondefect as $posdef) : ?>
                                       <?php 
                                       $gambar1 = $gambar['image'];
                                       $gambar2 = $posdef['image'];
                                       if ($gambar1 == $gambar2) {
                                       echo '<div><div class="defect-area-img-point" style="left:';?> <?= floatval($posdef['defect_area_x']) - floatval(80) ?><?php echo'px;top:';?> <?= floatval($posdef['defect_area_y']) - floatval(15) ?><?php echo'px;"></div></div>'; 
                                       }
                                       ?>
                                   <?php endforeach; ?>
                        ...
                        <div class="card-body" style="height: 515px;">
                            ...
                            <?php $i = 1; ?>
                                        <?php foreach ($list_defect as $dld) : ?>
                                            <div class="row">
                                                <div class="col-10">
                                            <span class="text-bold " style="font-size: 25px;"><?= $i; ?>. <?= $dld['defect_type']; ?></span>
                                            </div> 
                                            <div class="col-2">
                                                <span class="text-bold " style="font-size: 25px;">(<?= $dld['jml']; ?>)</span>
                                            </div>
                                            </div>
