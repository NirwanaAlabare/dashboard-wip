                ...
                <!-- /.col-md-6 -->
                  ...
                  <div class="col-lg-6">
                    <div class="card bg-secondary">
                       ...
                       <!-- <img style="opacity: .8;width: 620px;height: 470px;" src ='http://10.10.5.130:8000/storage/images/<?= $link_gambar; ?>' class="img-fluid defect-area-img" id="defect-area-img-show"> -->
                       <div class="show-defect-area" id="show-defect-area">
                        <div class="position-relative d-flex flex-column justify-content-center align-items-center">
                            <div class="defect-area-img-container mx-auto">
                                    <img style="opacity: .8;width: 620px;height: 470px;" src ='http://10.10.5.62:8001/storage/images/<?= $link_gambar; ?>' class="img-fluid defect-area-img" id="defect-area-img-show">
                                </div>
                            </div>
                        </div>
                        </div>
