                            ...
                            <table class="table table-dark border-collapse" style="font-size: 12px;text-align: center;border-radius: 10px;">
                                ...
                                <tbody>
                                    ...
                                    <tr style="line-height: 18px;">
                                        ...
                                        <td style="border-color: lightgray;font-size: 18px;"><?= $output9; ?></td>
                                        <td style="border-color: lightgray;font-size: 18px;"><?php
                                        if ($jamkerl1 < 3) {
                                            $target9 = '0';
                                        }elseif($jamkerl1 > 3){
                                        ...
                                        if ($target9 == '0') {
                                         ...
                                         $efficiency9 = $output9 / $target9 * 100;
                            ...
                            <table class="table table-dark" style="text-align: center;font-size: 14px;border-radius: 10px;">
                                ...
                                <tbody>
                                    <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                        <td style="font-size: 22px;border-radius: 10px;font-weight: bold;"><?= $day_target1; ?></td>
                                    </tr>
                                    <tr style="line-height: 22px;font-size: 16px;">
                                        <th scope="row" style="font-size: 20px;">Output</th>
                                    </tr>
                                    <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                        <td style="font-size: 22px;border-radius: 10px;font-weight: bold;"><?= $actuall1; ?></td>
                                    </tr>
                                   <tr style="line-height: 22px;font-size: 16px;">
                                    ...
                                    <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                        ...
                                        $variance_sum = $day_target1 - $actuall1;
                                    ...
                                    <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                        ...
                                        if ($day_target1 == '0') {
                                         ...
                                         $efficiency_sum = $actuall1 / $day_target1 * 100;
                                            echo round($efficiency_sum,2);
                                        ?>%</td>
                                    </tr>
                                    <tr style="line-height: 22px;font-size: 16px;">
                                    ...
                                    <tr class="bg-light" style="line-height: 23px;font-size: 16px;">
                                        ...
                                        if ($day_target1 == '0') {
                                         ...
                                         $deffect_sum = $deffectl1 / $day_target1 * 100;
