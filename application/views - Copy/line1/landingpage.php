        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 275px;">
                            <div id="chart_eff_line1" style="margin-bottom: -1rem; margin-top: -2rem;">
                            </div>
                            <p class="d-flex flex-column">
                ...
                <div class="col-lg-6">
                    <div class="card bg-secondary">
                        <div class="card-body" style="height: 275px;">
                            <div id="chart_def_line1" style="margin-bottom: -1rem; margin-top: -2rem;">
                            </div>
                            <p class="d-flex flex-column">
...
var redirect = function() {
    window.location = "line1/dashboard1";
};
